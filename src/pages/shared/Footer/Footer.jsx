      ...
      <div className="mx-auto w-full max-w-7xl px-8 pt-12">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Link
            ...
            <FaPuzzlePiece
              className="text-rose-600 inline-block text-accent"
              size={40}></FaPuzzlePiece>
            <div className="">
              <Typography
                as="span"
              ...
              <Typography
                as="span"
                className="inline-block text-3xl font-bold text-accent">
                Toys
              </Typography>
            </div>
          </Link>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            ...
            &copy; {currentYear} <a href="https://material-tailwind.com/">Edu Toys</a>. All Rights Reserved.
          </Typography>
